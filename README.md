# Home Assistant Add-on: ACME.sh (Pillarama)
This is a fork of https://github.com/wernerhp/ha_addon_acme_sh adding just some customisations. Please direct all coffees to Werner for his hard work.
...
<a href="https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%2Fpillarama%2Fha_addon_acme_sh" target="_blank"><img src="https://my.home-assistant.io/badges/supervisor_add_addon_repository.svg" alt="Open your Home Assistant instance and show the add add-on repository dialog with a specific repository URL pre-filled." /></a>
